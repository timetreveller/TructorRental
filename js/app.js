(() => {
        ...
        if (spollersArray.length > 0) {
                    ...
                    spollerItems.forEach((spollerItem => {
                        ...
                        if (hideSpollerBody) {
                            ...
                            if (!spollerItem.hasAttribute("data-open")) {
                                ...
                                spollerTitle.classList.add("_spoller-active1");
                                spollerItem.open = true;
                            }
                        } else {
                            spollerTitle.setAttribute("tabindex", "-1");
                            spollerTitle.classList.remove("_spoller-active1");
                            spollerItem.open = true;
            ...
            function setSpollerAction(e) {
                ...
                if (el.closest("summary") && el.closest("[data-spollers]").classList.contains("_spoller-init")) {
                    ...
                    if (!spollersBlock.querySelectorAll("._slide").length) {
                        ...
                        spollerTitle.classList.toggle("_spoller-active1");
                        _slideToggle(spollerTitle.nextElementSibling, spollerSpeed);
                        if (scrollSpoller && spollerTitle.classList.contains("_spoller-active1")) {
                ...
                if (!el.closest("[data-spollers]")) {
                    ...
                    if (spollersClose.length) spollersClose.forEach((spollerClose => {
                        ...
                        if (spollersBlock.classList.contains("_spoller-init")) {
                            const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 500;
                            spollerClose.classList.remove("_spoller-active1");
            ...
            function hideSpollersBody(spollersBlock) {
                ...
                if (spollerActiveBlock && !spollersBlock.querySelectorAll("._slide").length) {
                    ...
                    const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 500;
                    spollerActiveTitle.classList.remove("_spoller-active1");
    ...
    const isMmobile = {
        ...
        any: function() {
            return isMmobile.Android() || isMmobile.BlackBerry() || isMmobile.iOS() || isMmobile.Opera() || isMmobile.Windows();
        }
    };
    if (isMmobile.any()) {
